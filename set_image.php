...
if (!isset($ALLOWED_SITES)) {
	...
	$ALLOWED_SITES = array(
		...
		'amazon-images.urdupoint.com',
		'cdn.urdupoint.com',
		'noc.pakistanpoint.com',
		'imgcdn.pakistanpoint.com',
		'pakistanpoint.com',
...
if (!defined('FILE_CACHE_DIRECTORY')) {
	...
	define('FILE_CACHE_DIRECTORY', TRUE); // @todo test on more deployments
}
